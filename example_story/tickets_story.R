# Customizing everything on the chart;
# based on: https://github.com/adamribaudo/storytelling-with-data-ggplot
library(tidyverse)
library(ggplot2)
...
source("https://raw.githubusercontent.com/multidis/storytelling-with-data-ggplot/master/theme/theme_swd.R")

df <- read_csv("https://raw.githubusercontent.com/multidis/hult-data-strategy/main/example_story/tickets_data.csv") %>%
...
ggplot(df) + geom_line(aes(x = date, y = tickets, color = ticket_type),size = 2) + 
